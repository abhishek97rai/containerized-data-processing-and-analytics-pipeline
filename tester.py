...
def main():
    ...
    print("res 0 name: " + str(result[0]['name']))
    print("res 0 score: " + str(round(result[0]['score'], 5)))
    print("res 1 name: " + str(result[1]['name']))
    print("res 1 score: " + str(round(result[1]['score'], 5)))
